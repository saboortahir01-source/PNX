...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    body:
      ...
      footer(["pnx-complete-guide", "ai-seo-workflow-guide", "free-agentic-seo-tool"]),
    ctaLabel: "Run a Multi-Agent Audit",
    ctaPrompt: "Run a full multi-agent SEO audit on my site and rank the fixes by impact",
    related: ["pnx-complete-guide", "ai-seo-workflow-guide", "free-agentic-seo-tool"],
  },
  {
  ...
  },
  {
    ...
    body:
      ...
      footer(["multi-agent-seo-system-guide", "pnx-complete-guide", "free-agentic-seo-tool"]),
    ctaLabel: "Run the Workflow",
    ctaPrompt: "Run the full SEO workflow on my site and give me an effort-versus-impact plan",
    related: ["multi-agent-seo-system-guide", "pnx-complete-guide", "free-agentic-seo-tool"],
  },
];
