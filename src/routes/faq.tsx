...
const FAQ = [
  { q: "Is PNX really free?", a: "Yes. Every tool — SEO audit, AI keyword research, SERP analysis, YouTube SEO, AI content generator — is 100% free with no daily limits; optional accounts are available (Email, Google, GitHub) and there is no premium tier." },
  ...
  { q: "Do I need an account?", a: "No account is required for the core tools — open the chat and start. Optional accounts (Email, Google, GitHub) are available to save preferences and enable additional features." },
  { q: "Is there a daily limit?", a: "No. Use PNX as much as you need. If a specific feature has limits, we will say so in the UI." },
...
const GOOGLE_FAQ = [
  ...
  { q: "Does PNX store my Google data?", a: "No. Google API responses are processed in memory for your request and discarded. Nothing is retained on our servers unless explicitly stated." },
  ...
  { q: "Where is my chat history stored?", a: "Entirely in your browser's localStorage by default. If you choose to use optional account features, those are used to save preferences and profile information only." },
